<script setup>
	...
	const { results: product, execute } = useApi()
		...
		<div class="grid grid-cols-4 gap-10">
			<form class="mt-5 col-span-2" @submit.prevent="updateProduct">
				...
				<div class="mt-3">
					...
					<input id="product-title" @change="chooseImage" type="file" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
				</div>
			...
			<img class="border border-slate-200 col-span-2 w-full" :src="`/images/products/${ product.image }`" alt="">
		</div>
	</section>
